                ...
                <div>
                    <div className="px-10">
                        <div className="text-3xl font-extrabold">
                          Select your respective department 
                        </div>
                    </div>
                    <div className="pt-2">
                    <button type="button" onClick={() => window.location.href = './dept'} className="mt-8 w-full text-white bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Go to next page </button>
